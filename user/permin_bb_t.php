                        ...
                        <div class="col-md-9">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                   <h4 class="title">Daftar Permintaan Bahan Baku </h4>
                                </div>
                                <?php  
                                        $sql_cek="select * from permintaanbb order by id_permintaan_bb ASC";
                                ...
                                <div class="card-content table-responsive">
                                    ...
                                    ?>
                                            <tr>
                                                <td><?php echo $no; ?></td>
                                                <td><?php echo $data['id_permintaan_bb']; ?></td>
                                                <td><?php echo $data['tgl_permintaan']; ?></td>
                                                <td><?php echo $data['nm_brg']; ?></td>
                                                <td><?php echo $data['satuan_brg']; ?></td>
                                                <td><?php echo number_format($data['jumlah'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                            </tr>
                                    <?php 
                                         }
                                        }
