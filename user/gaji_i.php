...
include "koneksi.php";
    ...
    $sql="select MAX(id_gaji) from gaji";
    ...
    $new_ID = "G".sprintf("%06s","$no_urut");  //angka yang telah ditambah dengan dengan 1 kemudian  digabung kembali dengan "PM"
            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                      <div class="navbar-header">
                        <a class="navbar-brand" href="gaji_t.php"><i class="material-icons">library_books</i> Daftar Gaji Karyawan</a>
                        <a class="navbar-brand" href="gaji_i.php"> <i class="material-icons">content_paste</i>Input Gaji Karyawan</a>
                    </div>
                </div>
            </nav>
            <div class="content">
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                    <h4 class="title">Input Gaji Karyawan</h4>
                                </div>
                                <div class="card-content">
                                    <form  action="gaji_i_res.php" method="post">
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">ID Gaji</label>
                                                    <input type="text" class="form-control" value ="<?php echo $new_ID?>" name="id_gaji" readonly>
                                                </div>
                                            </div>
											<div class="col-md-6">
                                                <div class="form-group label-floating">
											...
											<div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="number" class="form-control"  name="jml_gaji" required>
                                                </div>
                                            </div>
