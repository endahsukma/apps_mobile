            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                      <div class="navbar-header">
                        <a class="navbar-brand" href="pemasok_t.php"><i class="material-icons">library_books</i> Daftar Pemasok</a>
                        <a class="navbar-brand" href="pemasok_i.php"> <i class="material-icons">content_paste</i>Input Pemasok</a>
                    </div>
                </div>
            </nav>
            <div class="content">
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <form  action="pemasok_i_res.php" method="post">
                                            <div class="col-md-2">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">ID Pemasok</label>
