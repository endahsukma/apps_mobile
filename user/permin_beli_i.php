...
include "koneksi.php";
    ...
    $sql="select MAX(no_form) from permintaanpembelian";
    ...
    $new_ID = "NF".sprintf("%06s","$no_urut");  //angka yang telah ditambah dengan dengan 1 kemudian  digabung kembali dengan "PM"
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                    <h4 class="title">Input Permintaan Pembelian</h4>
                                </div>
                                <div class="card-content">
                                    <form  action="permin_beli_res.php" method="post">
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Nomor Form</label>
                                                    <input type="text" class="form-control" value ="<?php echo $new_ID?>" name="no_form" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <input type="date" class="form-control" name="tgl_permintaan_pembelian" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Nominal Permintaan Pembelian</label>
                                                    <input type="text" class="form-control" name="nominal_permintaan_pembelian" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Jenis Pembelian</label>
												<input type="checkbox" class="form-control" name="jenis_pembelian[]" value="Bahan baku" >Bahan baku
			  									<input type="checkbox" class="form-control" name="jenis_pembelian[]" value="Gelas" >Gelas
                                                </div>
                                            </div>
