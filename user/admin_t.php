            ...
            <nav class="navbar navbar-transparent navbar-absolute">
                <div class="container-fluid">
                      <div class="navbar-header">
                        <a class="navbar-brand" href="admin_t.php"><i class="material-icons">library_books</i> Daftar User</a>
                        <a class="navbar-brand" href="admin_i.php"> <i class="material-icons">content_paste</i>Input User</a>
                    </div>
                </div>
            </nav>
            <div class="content">
