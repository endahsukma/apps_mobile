...
include "koneksi.php";
    ...
    $sql="select MAX(id_produksi) from produksi";
    ...
    $new_ID = "PR".sprintf("%06s","$no_urut");  //angka yang telah ditambah dengan dengan 1 kemudian  digabung kembali dengan "PM"
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                    <h4 class="title">Input Catatan Produksi</h4>
                                </div>
                                <div class="card-content">
                                    <form  action="produksi_i_res.php" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">No Transaksi</label>
                                                    <input type="text" class="form-control" value ="<?php echo $new_ID?>" name="id_produksi" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Jumlah Input PDP</label>
                                                    <input type="number" class="form-control" name="pdp_i" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Jumlah Input Bahan Baku</label>
                                                    <input type="number" class="form-control" name="bb_i" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Jumlah Output Gelas</label>
                                                    <input type="number" class="form-control" name="gelas_o" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Jumlah Output PDP</label>
                                                    <input type="number" class="form-control" name="pdp_o" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Jumlah Output Bahan Baku</label>
                                                    <input type="number" class="form-control" name="bb_o" required>
                                                </div>
                                            </div>
                                        </div>
