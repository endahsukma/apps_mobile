                        ...
                        <div class="col-md-9">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                   <h4 class="title">Catatan Penerimaan Kas </h4>
                                </div>
                                <?php  
                                        $sql_cek="select * from penerimaankas";
                                ...
                                <div class="card-content table-responsive">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo number_format($data['debet'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
		                                        <td> <?php echo number_format ($kredit, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                                 <td> <?php echo number_format ($saldo, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
