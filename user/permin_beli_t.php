                        ...
                        <div class="col-md-9">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                   <h4 class="title">Daftar Permintaan Pembelian </h4>
                                </div>
                                <?php  
                                        $sql_cek="select * from permintaanpembelian group by no_form order by id ASC";
                                ...
                                <div class="card-content table-responsive">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data['nominal_permintaan_pembelian']; ?></td>
                                                <td class="text-primary">
                                                     <a title="Cek" href=permin_beli_bukti.php?no_form=<?php echo $data['no_form']; ?>>CEK</a>
                                                </td>
                                            </tr>
                                    <?php 
                                         }
